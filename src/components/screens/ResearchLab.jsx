...
import verifications from '@/data/verifications.json'
...
const VERIFICATION_MAP = verifications

function VerifyTab() {
  const [searchId, setSearchId] = useState('PRED-2025-AX992')
  ...
  const handleVerify = () => {
    ...
    window.setTimeout(() => {
      const row = VERIFICATION_MAP[id]
      if (row) {
        setVerifiedRecord(row)
        setVerifyError(null)
      } else {
        setVerifiedRecord(null)
        setVerifyError(`No ledger record for "${id}". Try PRED-2025-AX992 or PRED-2025-DR821.`)
      }
      ...
      <div className="lg:col-span-5 space-y-6">
          ...
          <div className="space-y-4">
            <div>
               ...
               <input 
                 ...
                 placeholder="e.g. PRED-2025-AX992"
               />
            </div>
            <button 
              type="button"
        ...
        <GlassPanel className="p-6">
          ...
          <div className="space-y-3">
             <div className="flex justify-between items-center text-xs p-2 hover:bg-slate-800/50 rounded transition-colors cursor-pointer">
               <span className="font-mono text-cyan-400">PRED-2025-DR821</span>
               <span className="text-slate-500">12 mins ago</span>
             </div>
             <div className="flex justify-between items-center text-xs p-2 hover:bg-slate-800/50 rounded transition-colors cursor-pointer">
               <span className="font-mono text-cyan-400">PRED-2025-LN404</span>
               <span className="text-slate-500">1 hour ago</span>
             </div>
             <div className="flex justify-between items-center text-xs p-2 hover:bg-slate-800/50 rounded transition-colors cursor-pointer">
               <span className="font-mono text-cyan-400">PRED-2025-ST119</span>
              ...
              <GlassPanel className="h-full p-0 flex flex-col border-emerald-500/30">
                ...
                <div className="p-6 flex-1 overflow-y-auto space-y-6">
                  <div className="bg-slate-800/40 rounded-xl p-5 border border-slate-700/50">
                    ...
                    <div className="mt-3 text-xs font-mono text-slate-500">Record hash: {verifiedRecord.hash}</div>
                  </div>
                  ...
                  <div className="border border-slate-700/50 rounded-xl p-4 bg-[#0a0e17]/50">
                     <div className="text-xs text-slate-400 font-bold uppercase tracking-widest mb-4">SHAP factors (Recharts)</div>
            ...
            >
              ...
              <p className="text-sm text-slate-500 max-w-md">
                {hasAttempted && verifyError
                  ...
                  : 'Enter a Prediction ID and click Authenticate & Verify to load the evidence chain and SHAP chart from the local verification table.'}
              </p>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <GlassPanel className="p-0 overflow-hidden">
        <div className="bg-slate-800/80 p-5 border-b border-slate-700/50 flex justify-between items-center">
          ...
          <div className="flex gap-4 text-sm">
            <span className="text-slate-400">Total Blocks: <span className="text-white font-mono">59,204</span></span>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-slate-300 border-collapse">
            ...
            <tbody className="divide-y divide-slate-800/50">
              {[
                {h: "59,204", t: "2025-01-30 18:42:01", id: "PRED-2025-AX992", m: "XGB_Yield_v3", hash: "0x7a8b...6789"},
                {h: "59,203", t: "2025-01-30 18:35:12", id: "PRED-2025-DR821", m: "CNN_Earth_v4", hash: "0x3f1c...ab42"},
                {h: "59,202", t: "2025-01-30 17:10:44", id: "PRED-2025-LN404", m: "GNN_Astro_v2", hash: "0x9d4e...f211"},
                {h: "59,201", t: "2025-01-30 15:22:09", id: "PRED-2025-ST119", m: "CNN_Earth_v4", hash: "0x1a2b...3c4d"},
                {h: "59,200", t: "2025-01-30 14:05:33", id: "PRED-2025-XX881", m: "XGB_Yield_v3", hash: "0xc8d7...e6f5"},
              ].map((row, i) => (
                <tr key={i} className="hover:bg-slate-800/30 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-900/40 text-emerald-400 border border-emerald-500/30 uppercase">
                      Verified
                    </span>
                  </td>
                </tr>
