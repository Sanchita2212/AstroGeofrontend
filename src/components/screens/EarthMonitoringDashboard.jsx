        ...
        <div className="lg:col-span-4 h-full flex flex-col gap-6">
          ...
          <GlassPanel className="p-6">
            ...
            <div className="space-y-2">
               ...
               <div className="flex justify-between text-sm"><span className="text-slate-400">Altitude</span> <span className="text-slate-200">420 km</span></div>
          ...
          <GlassPanel className="p-6 flex-1 flex flex-col">
            ...
            <div className="flex-1 space-y-3 overflow-y-auto pr-2">
              ...
              <div className="flex justify-between items-center p-3 rounded-xl bg-slate-800/30 border border-slate-700/50">
                <div>
                  <div className="text-sm font-semibold text-slate-200">Feb 02, 8:36 PM</div>
                  <div className="text-xs text-slate-500">Max ELEV: 15° 8:38 PM</div>
                </div>
                <div className="text-right">
                  <div className="inline-block px-2 py-0.5 rounded text-xs font-bold bg-rose-900/40 text-rose-500 border border-rose-500/30">LOW</div>
                  <div className="text-xs text-slate-500 mt-1">A Conditions given</div>
                </div>
              </div>
            </div>
